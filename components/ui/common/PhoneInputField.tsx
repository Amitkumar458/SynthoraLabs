      ...
      <div ref={wrapperRef} className="relative">
        ...
        >
          ...
          >
            ...
            {/* Dial code */}
            <span className="text-xs tabular-nums text-gray-500 font-semibold">
              {selected.dialCode}
            </span>
            <ChevronDown
              className={cn(
        ...
        {open && (
          <div
            ...
            className={cn(
              ...
              "w-72 rounded-xl border border-gray-200 bg-white",
              "shadow-xl shadow-indigo-100/50 ring-1 ring-black/5",
              // subtle entrance animation (tw-animate-css)
